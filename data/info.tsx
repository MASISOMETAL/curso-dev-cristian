...
export const coursesData: CourseData[] = [
  {
    ...
    modules: [
      { id: 1, title: "Introduction al HTML", description: "Aprende conceptos básicos, la sintaxis, estructura, DOM" },
      ...
      { id: 4, title: "Semántica y Agrupación", description: "Arquitectura Web, Divisores, fieldset, etiquetas de estructurado, popovertarget y dialog" },
      { id: 5, title: "Formularios", description: "Conceptos, inputs y labels, tipo de inputs, listas desplegables, textarea, datalist, tablas" },
      { id: 6, title: "Elemento Head", description: "Contenido del Head, title, meta, link, style, script, SEO" },
    ],
  },
  {
    id: "css",
